...
export class FetchPriceQuery implements Action {
  ...
  constructor(public symbol: string, public fromDate: string, public toDate: string) {}
}
...
export class PriceQueryFetched implements Action {
  ...
  constructor(public queryResults: PriceQueryResponse[], public fromDate: string, public toDate: string) {}
}
